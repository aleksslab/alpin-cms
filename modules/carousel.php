...
<div class="carousel-module relative w-full h-[500px] md:h-[600px] overflow-hidden group" data-autoplay="<?php echo $autoplay ? 'true' : 'false'; ?>" data-interval="<?php echo $interval; ?>">
    ...
    foreach ($slides as $i => $slide) { 
        ...
        ?>
        <div class="carousel-slide absolute inset-0 transition-opacity duration-1000 ease-in-out <?php echo $activeClass; ?>">
    ...
    <!-- Кнопки управления -->
    <button class="carousel-prev absolute left-6 top-1/2 -translate-y-1/2 z-30 w-14 h-14 bg-white/20 hover:bg-white/40 rounded-full flex items-center justify-center text-white backdrop-blur-md border border-white/30 transition-all opacity-0 group-hover:opacity-100 hover:scale-110 cursor-pointer">
        <span class="icon-chevron-left text-2xl"></span>
    </button>
    <button class="carousel-next absolute right-6 top-1/2 -translate-y-1/2 z-30 w-14 h-14 bg-white/20 hover:bg-white/40 rounded-full flex items-center justify-center text-white backdrop-blur-md border border-white/30 transition-all opacity-0 group-hover:opacity-100 hover:scale-110 cursor-pointer">

...
foreach (array_keys($footerMenus) as $menuId) {
    ...
    if ($menu && !empty($menu['name'])) {
        ...
        // fallback если меню не загрузилось
...
<footer class="w-full bg-[#1A1E23] pt-16 pb-8 border-t border-slate-800">
    <div class="container mx-auto px-6 lg:px-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-slate-300">
                    <?php foreach ($items as $item): ?>
                        <li>
                            <a href="<?php echo e($item['url'] ?? '#'); ?>" class="hover:text-white transition-colors cursor-pointer">
            ...
            <?php
//            Или можно так
//            echo render_module('site-menu', ['menu_id' => 'header_main','menu_style' => 'vertical']);
//            echo render_module('site-menu', ['menu_id' => 'footer_about','menu_style' => 'vertical']);
//            echo render_module('site-menu', ['menu_id' => 'footer_help','menu_style' => 'vertical']);
//            echo render_module('site-menu', ['menu_id' => 'brands','menu_style' => 'vertical']);
            ?>

<?php
// templates/footers/default/footer.php
...
// Собираем контакты — только заполненные
$contacts = [];
if (!empty($email)) {
...
<footer class="w-full bg-[#1A1E23] pt-16 pb-8 border-t border-slate-800">
    <div class="container mx-auto px-6 lg:px-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-slate-300">
                    <?php foreach ($items as $item): ?>
                        ...
                        ?>
                        <li>
                            <a href="<?php echo e(safeUrl($itemUrl)); ?>" class="hover:text-white transition-colors cursor-pointer">
            ...
            <?php // КОЛОНКА 5: Контакты (только заполненные) ?>
                ...
                <ul class="space-y-4 text-sm text-slate-300">
                    <?php foreach ($contacts as $contact): ?>
                        <li class="flex items-center gap-3">
                            <span class="<?php echo e($contact['icon']); ?> text-white"></span>
                            <?php if ($contact['type'] === 'email'): ?>
                                <a href="mailto:<?php echo e($contact['value']); ?>"><?php echo e($contact['text']); ?></a>
                            <?php elseif ($contact['type'] === 'phone'): ?>
                                <a href="tel:<?php echo e($contact['value']); ?>"><?php echo e($contact['text']); ?></a>
                            <?php else: ?>
                                <span><?php echo e($contact['text']); ?></span>
                            <?php endif; ?>
                        </li>
                    <?php endforeach; ?>
                </ul>
